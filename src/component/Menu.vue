...
<template>
    <div class="text-center" >
      <h3 class="text-4xl p-9   text-gray-900">Set Your Train</h3>
  
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div v-for="item in stats" :key="item.id" class="relative overflow-hidden rounded-lg bg-white px-6 pt-12 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
          ...
          <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
            ...
            <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
              <div class="text-sm">
                <a href="#" class="font-medium text-lg text-indigo-600 hover:text-indigo-500">
